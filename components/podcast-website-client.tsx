...
interface PodcastWebsiteClientProps {
  episodes: Episode[]
  firstEpisode: Episode
  platforms: Platform[]
}

export default function PodcastWebsiteClient({ episodes, firstEpisode, platforms }: PodcastWebsiteClientProps) {
  ...
  const renderLargePlatformIcon = (platform: Platform) => {
    switch (platform.icon) {
      case "spotify":
        return (
              ...
              <Link key={platform.name} href={platform.url} className="group" target="_blank" rel="noopener noreferrer">
                <div className="text-center p-6 hover:shadow-lg transition-all group-hover:scale-105 hover:bg-red-50 border rounded-lg">
                  <div className="space-y-3">
                    ...
                    >
                      {renderLargePlatformIcon(platform)}
                    </div>
